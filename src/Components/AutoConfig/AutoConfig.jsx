    ...
    <div id="autoconfig" className={Style.container}>
      ...
      <div className={Style.content}>
        ...
        <code id="auto2" className={Style.code} onClick={() =>
          ...
          <pre>ont auto-config name {DeviceNameRouter()}-VLAN-{values.vlanpon1} device-type {values.devicerouter} line {values.aimrouter1} interface gpon 0/1</pre>
          <pre>ont auto-config name {DeviceNameRouter()}-VLAN-{values.vlanpon2} device-type {values.devicerouter} line {values.aimrouter2} interface gpon 0/2</pre>
          <pre>ont auto-config name {DeviceNameRouter()}-VLAN-{values.vlanpon3} device-type {values.devicerouter} line {values.aimrouter3} interface gpon 0/3</pre>
          <pre>ont auto-config name {DeviceNameRouter()}-VLAN-{values.vlanpon4} device-type {values.devicerouter} line {values.aimrouter4} interface gpon 0/4</pre>
          <pre>ont auto-config name {DeviceNameRouter()}-VLAN-{values.vlanpon5} device-type {values.devicerouter} line {values.aimrouter5} interface gpon 0/5</pre>
          ...
          {checked && (
            <>
              ...
              <pre>ont auto-config name {DeviceNameRouter()}-VLAN-{values.vlanpon11} device-type {values.devicerouter} line {values.aimrouter11} interface gpon 0/11</pre>
              <pre>ont auto-config name {DeviceNameRouter()}-VLAN-{values.vlanpon12} device-type {values.devicerouter} line {values.aimrouter12} interface gpon 0/12</pre>
              <pre>ont auto-config name {DeviceNameRouter()}-VLAN-{values.vlanpon13} device-type {values.devicerouter} line {values.aimrouter13} interface gpon 0/13</pre>
              <pre>ont auto-config name {DeviceNameRouter()}-VLAN-{values.vlanpon14} device-type {values.devicerouter} line {values.aimrouter14} interface gpon 0/14</pre>
              <pre>ont auto-config name {DeviceNameRouter()}-VLAN-{values.vlanpon15} device-type {values.devicerouter} line {values.aimrouter15} interface gpon 0/15</pre>
              <pre>ont auto-config name {DeviceNameRouter()}-VLAN-{values.vlanpon16} device-type {values.devicerouter} line {values.aimrouter16} interface gpon 0/16</pre>
            </>
          )}
        </code>
      </div>
