...
import {
  ...
  DeviceOptionsRouter,
  ModoVlanOptions,
} from "../../../JS/DeviceOptions";
import ServiceContext from "../../../JS/ServiceContext";
import {
  DeviceNamesBridge,
  DeviceNamesRouter,
} from "../../../JS/DeviceNamesManual";
import {
  Onudesc,
  DbaName,
  vlanName,
    ...
    <div className={Style.container}>
      <form className={Style.content}>
        ...
        <div className={Style.pons}>
          ...
          <input
            type="number"
            name="dbaAssured"
            defaultValue={values.dbaAssured}
            onChange={handleChange}
          />
          <label>Max</label>
          <input
        ...
        <div className={Style.pons}>
          ...
          <input
            type="number"
            name="ProfileVlan"
            defaultValue={values.ProfileVlan}
            onChange={handleChange}
          />
          ...
          <input
            type="number"
            name="ProfileLine"
            defaultValue={values.ProfileLine}
            onChange={handleChange}
          />
      ...
      <div className={Style.contentCode}>
        ...
        >
          ...
          <pre>
            device type{" "}
            {!ProvManualMode ? values.devicerouter : values.devicebridge}{" "}
          </pre>
          ...
          {!ProvManualMode ? (
            ...
            <pre>
              mapping 1 port eth {values.onuEth} vlan {values.VlanVlan} gemport
              1
            </pre>
          )}
          {ProvManualMode ? (
        ...
        >
          ...
          <pre>
            permit sn string-hex {values.onuSn} line {values.ProfileLine}{" "}
            default line {values.ProfileLine}
          </pre>
          <pre>active</pre>
        </code>
        <hr />
        ...
        >
          ...
          <pre>
            ont auto-config name{" "}
            {ProvManualMode ? DeviceNamesBridge() : DeviceNamesRouter()}{" "}
            device-type{" "}
            {!ProvManualMode ? values.devicerouter : values.devicebridge} line{" "}
            {values.ProfileLine}
          </pre>
          <pre>active</pre>
        </code>
