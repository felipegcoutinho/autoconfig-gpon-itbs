...
export default function ProfileLineBridge() {
  const {values, modovlan, g16} = React.useContext(ValueContext);
    ...
    <div className={Style.container}>
      <div className={Style.content}>
        <code
          ...
          onClick={() => copyToClip(document.getElementById("linebridge1").innerText)}>
          <pre>deploy profile line</pre>
          <pre>
            aim {values.aimbridge1} name {values.devicebridge}_{values.vlanpon1}
          </pre>
          ...
          {modovlan ? (
            <pre>flow 1 port eth 1 vlan {values.vlanpon1} keep</pre>
          ) : (
        ...
        <code
          id="linebridge2"
          className={Style.code}
          onClick={() => copyToClip(document.getElementById("linebridge2").innerText)}>
          <pre>
            aim {values.aimbridge2} name {values.devicebridge}_{values.vlanpon2}
          </pre>
          <pre>device type {values.devicebridge}</pre>
          <pre>tcont 1 profile dba 1</pre>
          ...
          {modovlan ? (
            <pre>flow 1 port eth 1 vlan {values.vlanpon2} keep</pre>
          ) : (
        ...
        <code
          id="linebridge3"
          className={Style.code}
          onClick={() => copyToClip(document.getElementById("linebridge3").innerText)}>
          <pre>
            aim {values.aimbridge3} name {values.devicebridge}_{values.vlanpon3}
          </pre>
          <pre>device type {values.devicebridge}</pre>
          <pre>tcont 1 profile dba 1</pre>
          ...
          {modovlan ? (
            <pre>flow 1 port eth 1 vlan {values.vlanpon3} keep</pre>
          ) : (
        ...
        <code
          id="linebridge4"
          className={Style.code}
          onClick={() => copyToClip(document.getElementById("linebridge4").innerText)}>
          <pre>
            aim {values.aimbridge4} name {values.devicebridge}_{values.vlanpon4}
          </pre>
          <pre>device type {values.devicebridge}</pre>
          <pre>tcont 1 profile dba 1</pre>
          ...
          {modovlan ? (
            <pre>flow 1 port eth 1 vlan {values.vlanpon4} keep</pre>
          ) : (
        ...
        <code
          id="linebridge5"
          className={Style.code}
          onClick={() => copyToClip(document.getElementById("linebridge5").innerText)}>
          <pre>
            aim {values.aimbridge5} name {values.devicebridge}_{values.vlanpon5}
          </pre>
          <pre>device type {values.devicebridge}</pre>
          <pre>tcont 1 profile dba 1</pre>
          ...
          {modovlan ? (
            <pre>flow 1 port eth 1 vlan {values.vlanpon5} keep</pre>
          ) : (
        ...
        <code
          id="linebridge6"
          className={Style.code}
          onClick={() => copyToClip(document.getElementById("linebridge6").innerText)}>
          <pre>
            aim {values.aimbridge6} name {values.devicebridge}_{values.vlanpon6}
          </pre>
          <pre>device type {values.devicebridge}</pre>
          <pre>tcont 1 profile dba 1</pre>
          ...
          {modovlan ? (
            <pre>flow 1 port eth 1 vlan {values.vlanpon6} keep</pre>
          ) : (
        ...
        <code
          id="linebridge7"
          className={Style.code}
          onClick={() => copyToClip(document.getElementById("linebridge7").innerText)}>
          <pre>
            aim {values.aimbridge7} name {values.devicebridge}_{values.vlanpon7}
          </pre>
          <pre>device type {values.devicebridge}</pre>
          <pre>tcont 1 profile dba 1</pre>
          ...
          {modovlan ? (
            <pre>flow 1 port eth 1 vlan {values.vlanpon7} keep</pre>
          ) : (
        ...
        <code
          id="linebridge8"
          className={Style.code}
          onClick={() => copyToClip(document.getElementById("linebridge8").innerText)}>
          <pre>
            aim {values.aimbridge8} name {values.devicebridge}_{values.vlanpon8}
          </pre>
          <pre>device type {values.devicebridge}</pre>
          <pre>tcont 1 profile dba 1</pre>
          ...
          {modovlan ? (
            <pre>flow 1 port eth 1 vlan {values.vlanpon8} keep</pre>
          ) : (
        ...
        {g16 && (
          <>
            ...
            <code
              id="linebridge9"
              className={Style.code}
              onClick={() => copyToClip(document.getElementById("linebridge9").innerText)}>
              <pre>
                aim {values.aimbridge9} name {values.devicebridge}_{values.vlanpon9}
              </pre>
              <pre>device type {values.devicebridge}</pre>
              <pre>tcont 1 profile dba 1</pre>
              ...
              {modovlan ? (
                <pre>flow 1 port eth 1 vlan {values.vlanpon9} keep</pre>
              ) : (
            ...
            <code
              id="linebridge10"
              className={Style.code}
              onClick={() => copyToClip(document.getElementById("linebridge10").innerText)}>
              <pre>
                aim {values.aimbridge10} name {values.devicebridge}_{values.vlanpon10}
              </pre>
              <pre>device type {values.devicebridge}</pre>
              <pre>tcont 1 profile dba 1</pre>
              ...
              {modovlan ? (
                <pre>flow 1 port eth 1 vlan {values.vlanpon10} keep</pre>
              ) : (
            ...
            <code
              id="linebridge11"
              className={Style.code}
              onClick={() => copyToClip(document.getElementById("linebridge11").innerText)}>
              <pre>
                aim {values.aimbridge11} name {values.devicebridge}_{values.vlanpon11}
              </pre>
              <pre>device type {values.devicebridge}</pre>
              <pre>tcont 1 profile dba 1</pre>
              ...
              {modovlan ? (
                <pre>flow 1 port eth 1 vlan {values.vlanpon11} keep</pre>
              ) : (
            ...
            <code
              id="linebridge12"
              className={Style.code}
              onClick={() => copyToClip(document.getElementById("linebridge12").innerText)}>
              <pre>
                aim {values.aimbridge12} name {values.devicebridge}_{values.vlanpon12}
              </pre>
              <pre>device type {values.devicebridge}</pre>
              <pre>tcont 1 profile dba 1</pre>
              ...
              {modovlan ? (
                <pre>flow 1 port eth 1 vlan {values.vlanpon12} keep</pre>
              ) : (
            ...
            <code
              id="linebridge13"
              className={Style.code}
              onClick={() => copyToClip(document.getElementById("linebridge13").innerText)}>
              <pre>
                aim {values.aimbridge13} name {values.devicebridge}_{values.vlanpon13}
              </pre>
              <pre>device type {values.devicebridge}</pre>
              <pre>tcont 1 profile dba 1</pre>
              ...
              {modovlan ? (
                <pre>flow 1 port eth 1 vlan {values.vlanpon13} keep</pre>
              ) : (
            ...
            <code
              id="linebridge14"
              className={Style.code}
              onClick={() => copyToClip(document.getElementById("linebridge14").innerText)}>
              <pre>
                aim {values.aimbridge14} name {values.devicebridge}_{values.vlanpon14}
              </pre>
              <pre>device type {values.devicebridge}</pre>
              <pre>tcont 1 profile dba 1</pre>
              ...
              {modovlan ? (
                <pre>flow 1 port eth 1 vlan {values.vlanpon14} keep</pre>
              ) : (
            ...
            <code
              id="linebridge15"
              className={Style.code}
              onClick={() => copyToClip(document.getElementById("linebridge15").innerText)}>
              <pre>
                aim {values.aimbridge15} name {values.devicebridge}_{values.vlanpon15}
              </pre>
              <pre>device type {values.devicebridge}</pre>
              <pre>tcont 1 profile dba 1</pre>
              ...
              {modovlan ? (
                <pre>flow 1 port eth 1 vlan {values.vlanpon15} keep</pre>
              ) : (
            ...
            <code
              id="linebridge16"
              className={Style.code}
              onClick={() => copyToClip(document.getElementById("linebridge16").innerText)}>
              <pre>
                aim {values.aimbridge16} name {values.devicebridge}_{values.vlanpon16}
              </pre>
              <pre>device type {values.devicebridge}</pre>
              <pre>tcont 1 profile dba 1</pre>
              ...
              {modovlan ? (
                <pre>flow 1 port eth 1 vlan {values.vlanpon16} keep</pre>
              ) : (
